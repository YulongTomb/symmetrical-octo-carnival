...
$(function(){
    ...
    $(".rightSlide_ul li").hover(function(){
        if ($(this).index()<5) {
            ...
            $(".rightSlide_ul li").not($(this)).css("background-color","#4F82FF");
            $(this).css("background-color","#3E59FE");
            switch ($(this).index()){
                case 1:
    ...
    $(".rightSlide_ul li").click(function(){
        if (slideFlag) {
            $(".rightSlide_real li").hide();
            $(this).css("background-color","#4F82FF");
        }
    });
    ...
    $(".rightSlide_real li").on("mouseleave",function(){
        $(this).hide();
        $(".rightSlide_ul li").css("background-color","#4F82FF");
    });
